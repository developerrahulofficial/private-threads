    ...
    return (
        <div className=" z-[10] mt-4 flex w-full flex-col space-y-4">
            <div className="flex w-fullitems-center">
                <div className="flex w-full flex-col p-3 pl-0 gap-1">
                    ...
                    <div className="flex gap-1">
                        ...
                        <span className="ml-0.5 rounded-2xl bg-primary text-[#777777] text-xm px-1.5 py-1 text-[11px] font-medium">is on private theads ❤</span>
                    </div>
                </div>
            ...
            <div className='flex justify-between items-center'>
                ...
                <Link href="https://instagram.com/@developer_rahul_" className='text-[#00000] text-[15px] hover:underline cursor-pointer active:text-[#4d4d4d]'>
